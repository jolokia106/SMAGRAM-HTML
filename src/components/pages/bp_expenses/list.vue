<template>
    ...
    <div class="content-header">
        ...
        <div class="sort-area d-flex justify-content-end mt-5">
            ...
            <a href="/bp_expenses/form" class="new-button">
    ...
    <div class="content-body">
        <div class="list-table">
            ...
            <ul class="tr body">
                <li class="td">001</li>
                <li class="td">加盟店A</li>
                <li class="td">smileガーデン</li>
                <li class="td">違約金</li>
                <li class="td">金額</li>
                <li class="td">2022/2/25</li>
                <li class="td">2022/3/25</li>
                <li class="td sp-hidden">
                    <a href="/bp_expenses/form" class="btn btn-detail">詳細</a> 
                </li>
            </ul>
            <div class="sp-detail sp-only">
                <a href="/bp_expenses/form">〉</a>
            </div>
