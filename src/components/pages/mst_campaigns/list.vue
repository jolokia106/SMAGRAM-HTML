<template>
    ...
    <div class="content-header">
        ...
        <div class="sort-area d-flex justify-content-end mt-5">
            ...
            <a href="/mst_campaigns/form" class="new-button">
    ...
    <div class="content-body">
        <div class="list-table">
            ...
            <ul class="tr body">
                <li class="td">001</li>
                <li class="td">キャンペーン１</li>
                <li class="td">キャンペーンの内容キャンペーンの内容</li>
                <li class="td">予約</li>
                <li class="td sp-hidden">
                    <a href="/mst_campaigns/form" class="btn btn-detail">詳細</a> 
                </li>
            </ul>
            <div class="sp-detail sp-only">
                <a href="/mst_campaigns/form">〉</a>
            </div>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/mst_campaigns/list">
