<template>
    ...
    <div class="content-header">
        ...
        <div class="sort-area d-flex justify-content-end mt-5">
            ...
            <a href="/service_address/form" class="new-button">
    ...
    <div class="content-body">
        <div class="list-table">
            <ul class="tr head">
                <li class="th">加盟店コード</li>
                <li class="th">店舗</li>
                <li class="th">都道府県</li>
                <li class="th">市区町村</li>
                <li class="th">市区群以下</li>
            ...
            <ul class="tr body">
                ...
                <li class="td">北海道</li>
                <li class="td">札幌市</li>
                <li class="td">中央区北2条2丁目~</li>
                <li class="td sp-hidden">
                    <a href="/service_address/form" class="btn btn-detail">詳細</a> 
                </li>
            </ul>
            <div class="sp-detail sp-only">
                <a href="/service_address/form">〉</a>
            </div>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/service_address/list">
